...
const CancelStatusDetailsMap = ({ route, navigation }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                // RIDER_MAP_ID
                console.log("RIDER_MAP_ID-16-16===>", route.params.itemBokingDetailsMapId);
                ...
                await axios.get(url, {
                    ...
                    .then(response => {
                        if (response.status === 200
                            ...
                            setDefaultRatingsubmit(averageRating);
    ...
    const axiosPostRideDetailsOfMap = async () => {
        ...
        console.log("RideDetails33333===>", data);
        ...
        await axios.post(url, data, {
            ...
            .then(response => {
                if (response.status === 200
                    ...
                    console.log("USER_CANCELLATION***-----==>", USER_CANCELLATION);
                    console.log("PER-----==>", PER);
...
export default CancelStatusDetailsMap;
