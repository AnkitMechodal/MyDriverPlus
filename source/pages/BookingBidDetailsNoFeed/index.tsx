...
const BookingBidDetailsNoFeed = ({ route, navigation }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // GET REQUEST DATA
                await axiosPostGetRequestDriverList();
        ...
        <SafeAreaView style={CommonStyle.commonFlex}>
            ...
            <View style={Styles.container}>
                ...
                <Modal
                    ...
                    onBackButtonPress={() => setModalREQUEST(false)}>
                    <ScrollView style={Styles.container}>
                        <View style={Styles.container}>
...
export default BookingBidDetailsNoFeed;
