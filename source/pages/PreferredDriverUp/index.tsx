...
import { Image, Linking, Modal, SafeAreaView, ScrollView, TouchableOpacity, View } from 'react-native';
...
const PreferredDriverUp = ({ route, navigation }) => {
        ...
        await axios.post(url, data, {
            ...
            .then(response => {
                if (response.status === 200
                    ...
                    console.log("RideDetailsAllData===>", JSON.stringify(response?.data, null, 2));
...
export default PreferredDriverUp;