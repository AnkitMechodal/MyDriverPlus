...
const Tab3CourierScreen = (props: Props) => {
                    ...
                    return (
                        <View>
                            <View style={{ flex: 1, backgroundColor: 'black' }}>
                                ...
                                <TouchableOpacity
                                    onPress={() =>
                                        props.navigation.navigate("CourierRequestPast", {
                                            itemTYPE: item.type,
...
export default Tab3CourierScreen;