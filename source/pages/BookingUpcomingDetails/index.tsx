...
const BookingUpDetails = ({ route, navigation }) => {
    ...
    const [isRIDEDUR, setRIDEDUR] = useState("");
    const [isRIDEDIS, setRIDEDIS] = useState("");
        ...
        await axios.post(url, data, {
            ...
            .then(response => {
                if (response.status === 200
                    ...
                    USER_DISCOUNT_ = USER_TOTAL_AMOUNT - USER_DISCOUNT;
                    setTOTAL_AMOUNT(USER_DISCOUNT_);
...
export default BookingUpDetails;
