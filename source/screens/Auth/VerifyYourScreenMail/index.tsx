...
const VerifyYourScreenMail = ({ route, navigation }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const userId = route?.params?.itemEmailMail;
    ...
    }, [route?.params?.itemEmailMail]);


    const storeAccountId = async (storeid: any) => {
        try {
            await AsyncStorage.setItem('user_id_mail', JSON.stringify(storeid));
            console.log('user_id_mail===>', JSON.stringify(storeid));
        } catch (error) {
            // Handle any errors that might occur during the storage operation
            console.log('Error user_id_mail :', error);
        }
    }
...
export default VerifyYourScreenMail;
