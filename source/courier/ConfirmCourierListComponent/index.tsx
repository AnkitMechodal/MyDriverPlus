...
const ConfirmCourierListComponent = ({ data, handleGetItemDetails }: ConfirmBookingListProps) => {
            ...
            >
                ...
                <View style={Styles.viewSecond}>
                    <View style={CommonStyle.justifyContent}>
                        ...
                        <TextComponent
                            color={Colors.gray}
                            title={item?.sub_detail} // vehicleSeatNo
                            textDecorationLine={'none'}
                            fontWeight="600"
                            fontSize={wp(3)}
                            fontFamily={Fonts.PoppinsRegular}
...
export default ConfirmCourierListComponent;
