...
const CourierRequestPast = ({ route, navigation }) => {
    ...
    const axiosPostSetProfileData = async () => {
        ...
        if (type !== null && storedLinkedId !== null) {
            ...
            console.log("user_register_id--->", user_point);
            console.log("user_register_id--->", user_point);
            console.log("user_register_id--->", user_point);
            console.log("user_register_id--->", user_point);
                ...
                await axios.post(url, data, {
                    ...
                    .then(response => {
                        if (response.status === 200 &&
                            ...
                            console.log("user_point1111--->", user_point);
                            console.log("user_point2222--->", user_point);
                            console.log("user_point3333--->", user_point);
                            console.log("user_point1111--->", user_point);
                            console.log("user_point2222--->", user_point);
                            console.log("user_point3333--->", user_point);
                        ...
                        <View style={CommonStyle.commonFlex}>
                            <View style={Styles.viewHeader}>
                                <HeaderComponent
                                    ...
                                    fontFamily={Fonts.InterSemiBold}
                                    fontWeight="500"
                                    title={"Courier Booking Details"} //uPUPUPPUPu
                                    fontSize={wp(4)}
